...
const collections = [
  ...
  },
  {
    ...
    indexes: [
      { key: { from_user_id: 1, to_user_id: 1, created_at: -1 }, options: { name: "private_message_from_to_created_idx" } },
      { key: { to_user_id: 1, status: 1 }, options: { name: "private_message_to_status_idx" } }
    ]
  },
  {
    name: "group_message",
    validator: {
      $jsonSchema: {
        bsonType: "object",
        required: ["from_user_id", "group_id"],
        properties: {
          from_user_id: { bsonType: "objectId" },
          group_id: { bsonType: "objectId" },
          message: { bsonType: ["string", "null"] },
    ...
    indexes: [
      { key: { group_id: 1, created_at: -1 }, options: { name: "group_message_group_created_idx" } },
      { key: { from_user_id: 1 }, options: { name: "group_message_from_user_idx" } }
    ]
  },
  {
    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          from_user_id: { bsonType: "objectId" },
          thema: { bsonType: ["string", "null"] },
          message: { bsonType: ["string", "null"] },
          answered: { bsonType: ["bool", "null"] },
          edited: { bsonType: ["bool", "null"] },
          created_at: { bsonType: ["date", "null"] }
        },
        additionalProperties: true
    ...
    indexes: [
      { key: { created_at: -1 }, options: { name: "global_questions_created_idx" } },
      { key: { from_user_id: 1 }, options: { name: "global_questions_from_user_idx" } }
    ]
  },
  {
    name: "question_likes",
    ...
    indexes: [
      { key: { user_id: 1, question_id: 1 }, options: { unique: true, name: "question_likes_unique_pair" } },
      { key: { question_id: 1 }, options: { name: "question_likes_question_idx" } }
    ]
  },
  {
    name: "global_answers",
    validator: {
      $jsonSchema: {
        bsonType: "object",
        required: ["question_id", "from_user_id"],
        properties: {
          question_id: { bsonType: "objectId" },
          from_user_id: { bsonType: "objectId" },
          message: { bsonType: ["string", "null"] },
    ...
    indexes: [
      { key: { question_id: 1, created_at: -1 }, options: { name: "global_answers_question_created_idx" } },
      { key: { from_user_id: 1 }, options: { name: "global_answers_from_user_idx" } }
    ]
  },
  {
    name: "answer_likes",
    validator: {
      $jsonSchema: {
        bsonType: "object",
        required: ["answer_id", "user_id"],
        properties: {
          answer_id: { bsonType: "objectId" },
          user_id: { bsonType: "objectId" },
          created_at: { bsonType: ["date", "null"] }
        },
        additionalProperties: true
    ...
    indexes: [
      { key: { answer_id: 1, user_id: 1 }, options: { unique: true, name: "answer_likes_unique_pair" } },
      { key: { answer_id: 1 }, options: { name: "answer_likes_answer_idx" } }
    ]
  }
];
