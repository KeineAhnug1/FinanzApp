...
export function createPrivateMessageEntity({
  _id,
  from_user_id,
  to_user_id,
  message = null,
...
export function createGroupMessageEntity({
  _id,
  from_user_id,
  group_id,
  message = null,
...
export function createGlobalQuestionEntity({
  _id,
  from_user_id,
  thema = null,
  message = null,
...
export function createQuestionLikeEntity({
  _id,
  user_id,
  question_id,
  created_at = null
  ...
  return {
    ...(_id ? { _id: toObjectId(_id) } : {}),
    user_id: toObjectId(user_id),
    question_id: toObjectId(question_id),
    created_at: created_at == null ? null : toDate(created_at)
  };
}

export function createGlobalAnswerEntity({
  _id,
  question_id,
  from_user_id,
  message = null,
...
export function createAnswerLikeEntity({
  _id,
  answer_id,
  user_id,
  created_at = null
  ...
  return {
    ...(_id ? { _id: toObjectId(_id) } : {}),
    answer_id: toObjectId(answer_id),
    user_id: toObjectId(user_id),
    created_at: created_at == null ? null : toDate(created_at)
  };
}
