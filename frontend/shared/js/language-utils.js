(function initFinanzAppLanguage() {
  ...
  function resolveTranslation(sourceText, locale) {
  ...
  function applyTranslations(root = document.documentElement) {
    ...
    while (node) {
      ...
      if (parentName !== "SCRIPT" && parentName !== "STYLE") {
        ...
        const translated = resolveTranslation(source, locale);
    ...
    for (const element of elements) {
      ...
      for (const attr of attrNames) {
        ...
        const translated = resolveTranslation(sourceAttrs.get(attr), locale);
