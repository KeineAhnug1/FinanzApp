...
import { EmptyState, IconLineChart } from '@/components/ui/EmptyState';
    ...
    <div className="depot-page">
      ...
      {positions.length === 0 ? (
        <EmptyState
          ...
          description="Suche oben nach einer Aktie, um deine erste Position zu eröffnen."
          cta={{ label: 'Zur Suche', onClick: scrollToSearch }}
        />
      ) : (
        <>
                ...
                {chartLoading ? (
                  ...
                  <div style={{ height: 220, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <EmptyState
                      size="sm"
                      icon={<IconLineChart />}
                      title="Keine Kursdaten"
                      description="Für diesen Zeitraum sind keine Kursdaten verfügbar."
                    />
                  </div>
                )}
              </div>
