...
import { EmptyState, IconBriefcase } from '@/components/ui/EmptyState';
  ...
  return (
    <div className="group-section">
      ...
      {!isLoading && sortedTrips.length === 0 && (
        <EmptyState
          icon={<IconBriefcase />}
          title="Keine Ausflüge"
          description="Plane einen Ausflug und lass die Gruppe Ausgaben dafür eintragen."
          cta={{ label: 'Neuer Ausflug', onClick: () => setShowCreate(true) }}
        />
      )}
