(function initShareViewAccountUtils() {
  ...
  function mapApiAccounts(rawAccounts, fallbackPrefix) {
  ...
  async function loadAccountsByEndpoints(endpoints, fallbackPrefix, options = {}) {
