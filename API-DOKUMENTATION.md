...
| **Frontend** | `frontend/einstellungen/app.js` → `handlePasswordChange()` |
...
| **Frontend** | `frontend/einstellungen/app.js` → `initProfileImageUpload()` |
...
| **Frontend** | `frontend/einstellungen/app.js` → `handleAccountDelete()` |
